...
rf_pipeline = Pipeline(steps=[
    ...
    ("model", rf_model)
        ...
        <section id="conclusion">
          ...
          <h3>Discussion</h3>
          <p>
            [Elaborate on why age has minimal predictive power. Discuss
            confounding variables like playing time, team quality, coaching
            scheme, injury history, talent level]
          </p>
          <p>
            [Explain practical implications: fantasy managers should prioritize
            opportunity and role over age when evaluating players in the 22-35
            range]
          </p>
          <p>
            [Discuss the clustering findings: natural player archetypes exist
            based on position and career stage, but age alone doesn't determine
            fantasy value]
          </p>
